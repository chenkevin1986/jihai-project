...
public class QRCodeUtil {
    ...
    public static String encode(String content, String logoPath, String destPath, boolean needCompress) throws Exception {
        ...
        mkdirs(destPath);
        String fileName = ThreadLocalRandom.current().nextInt(99999999) + "." + FORMAT.toLowerCase();
    ...
    public static void main(String[] args) throws Exception {
        ...
        //含Logo，指定二维码图片名
//        QRCodeUtil.encode(text, "D:\\1.jpg", "D:\\", "qrcode", true);
        System.out.println(decode("D:\\qrcode.jpg"));
    }
