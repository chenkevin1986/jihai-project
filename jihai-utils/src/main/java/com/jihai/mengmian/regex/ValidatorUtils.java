package com.jihai.mengmian.regex;
 ...
 * 正则表达式校验 与RegexUtils一样的 支持的类型多一些
 * 该工具类 定义了常见的正则表达式，开发者可以直接引用。
 */
...
////------------------验证方法
    ...
    public static final String HEX_2_REG= "^[A-Fa-f0-9]{2}$";

    /**
     * 判断字符串是不是2位16进制字符串
     * @return
     */
    public static boolean isHex2Str(String hexStr){
        return regular(hexStr,HEX_2_REG);
    }

    public static final String HEX_4_REG= "^[A-Fa-f0-9]{4}$";

    /**
     * 判断字符串是不是4位16进制字符串
     * @return
     */
    public static boolean isHex4Str(String hexStr){
        return regular(hexStr,HEX_4_REG);
    }

    public static final String HEX_8_REG= "^[A-Fa-f0-9]{8}$";

    /**
     * 判断字符串是不是8位16进制字符串
     * @return
     */
    public static boolean isHex8Str(String hexStr){
        return regular(hexStr,HEX_8_REG);
    }
    ...
    public static boolean isHexStr(String hexStr){
        return regular(hexStr,HEX_REG);
    }
    /**该正则校验比较粗,没有判断一个月有30天、29天，28天的情况以及闰年的情况*/
    public static final String YYYY_MM_DD = "^2[0-9]{3}((0[1-9])|(1[012]))(0[1-9]|[12][0-9]|3[01])$";

    public static final String YYYY_MM = "^2[0-9]{3}((0[1-9])|(1[012]))$";

    public static final String YYYY = "^2[0-9]{3}$";
     ...
     * @return
     */
    public static boolean isYearStr(String timeStr){
        return regular(timeStr,YYYY);
    }

    public static boolean isMonthStr(String timeStr){
        return regular(timeStr,YYYY_MM);
    }

    /**
     * 该正则校验比较粗
     * 没有判断一个月有30天、29天，28天的情况
     * 以及闰年的情况。
     * @param timeStr
     * @return
     */
    public static boolean isDayStr(String timeStr){
        return regular(timeStr,YYYY_MM_DD);
    }
