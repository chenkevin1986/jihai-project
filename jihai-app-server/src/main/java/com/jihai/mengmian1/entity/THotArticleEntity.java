...
@NoArgsConstructor
@Entity
@Table(name = "t_hot_article")
public class THotArticleEntity {
    ...
    @Column(name="Ffrom_plate_id",columnDefinition = "int(11) unsigned NOT NULL COMMENT ''")
    private Integer fromPlateId;
